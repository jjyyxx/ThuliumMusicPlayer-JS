const { Tokenizer } = require('smml-tokenizer-js')
const { Player } = require('webaudiofont')
const { Parser, MIDIAdapter } = require('qingyun-musicplayer-parser')
import {defineLanguage, showEditor} from './editor'

window.require.config({ paths: { 'vs': 'vs' } })
window.require(['vs/editor/editor.main'], function () {
    defineLanguage()
    showEditor().addAction({
        id: 'smml-play',
...
function play(result) {
    var tracks = new Parser(new Tokenizer(result).tokenize(), new MIDIAdapter()).parse()
